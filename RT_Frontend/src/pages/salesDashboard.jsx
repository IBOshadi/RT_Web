    ...
    return labels.map(({ key, label }, index) => {
      ...
      return (
        <div key={index} className="mb-3">
          ...
          >
            <span className="font-bold text-lg">{label}:</span>
            <span>{isNetSales ? formatValue(value) : formatValue(value)}</span>
          </div>
        </div>
      );
    });
      ...
      >
          ...
          {alert && <Alert message={alert.message} type={alert.type} onClose={() => setAlert(null)} />}
                ...
                <div className="flex items-center w-full">
                  ...
                  <div>
                    <button
                      ...
                      className="bg-black text-white px-4 py-2 rounded-md shadow-md hover:bg-gray-800 mt-7"
                    >
                      Submit
                    </button>
                  </div>
            ...
            <div
              ...
              style={{ backgroundColor: "#d8d8d8" }}
            >
              <div className="flex flex-col lg:w-1/4 w-full bg-white p-5 rounded-md shadow-md mb-5 lg:mb-0 mr-5">
